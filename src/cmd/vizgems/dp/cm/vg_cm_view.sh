...
function vg_cm_view_list {
    ...
    for i in $VGCM_VIEWDIR/*-inv.txt; do
        id=${i##*/}
        id=${id%-inv.txt}
        [[ ! -f $i ]] && continue
        [[ ${map[$id]} == '' ]] && continue
